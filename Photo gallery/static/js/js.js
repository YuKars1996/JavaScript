 ...
 * @property {string} settings.openedImageNotFoundSrc Путь до картинки в случае отстутствия основной.
 */
const gallery = {
  settings: {
    ...
    openedImageCloseBtnSrc: '../FinTravel/static/img/gallery/close.png',
    openedImageNotFoundSrc: '../FinTravel/static/img/gallery/404.jpg',
  },
